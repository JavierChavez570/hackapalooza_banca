...
<html lang="en">
  <head>
    ...
    <title>Rocket | Admin Dashboard v1.0</title>
  ...
  <body>
      ...
      <div class="container-fluid">
        ...
        <div  class="collapse navbar-collapse hidden-xs">
          ...
          <ul class="nav navbar-nav navbar-right notify">
            ...
            <li class="dropdown">
              <a href="#" class="notification dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-camera-retro fa-lg fa" aria-hidden="true"></i></a>
            ...
            <li class="dropdown">
              <a href="#" class="messages dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-envelope" aria-hidden="true"></i></a>
         	...
         	<form class="nav-search">
              <input class="nav-search-input" type="text" spellcheck="false" placeholder="Buscar...">
    ...
    <div class="contentWrapper">
      <div class="row">
        <h1 style="float: left;">Banka Online <h4>La nueva cara de la banca. </h4></h1>
        <h4> <marquee behavior="" direction="left"><h3><?php echo $nombre; ?> Tenemos excelentes promociones en <a href="promotions.php"><?php echo $analizis_actividades; ?></a></h3></marquee> </h4>
      </div>
      <div class="row cards">